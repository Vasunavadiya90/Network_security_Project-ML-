...
from networksecurity.utils.main_utils.util import read_yaml_file
import pandas as pd
...
class DataValidation:
    def __init__(self,
        ...
        ## we have to get a data from data ingestion class like in artifactfolder and also gathering the configuration of datavalidationconfiguration
        try:
